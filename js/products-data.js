...
const PRODUCTS = [
  ...
  { id: "mer-07", brand: "mercola", name: "Liposomal Hyaluronic Acid", category: "belleza", price: null, image: "img/productos/liposomal-hyaluronic-acid.jpg" },
  { id: "mer-08", brand: "mercola", name: "Astaxanthin", category: "antioxidantes", price: null, image: "img/productos/astaxanthin.jpg" },
  { id: "mer-09", brand: "mercola", name: "Vitamin E", category: "vitaminas", price: null, image: "img/productos/vitamin-e.jpg" },
  { id: "mer-10", brand: "mercola", name: "Vitamin D3 & K2", category: "vitaminas", price: null, image: "img/productos/vitamin-d3-k2.jpg" },
  { id: "mer-11", brand: "mercola", name: "Organic Fermented Turmeric (Cúrcuma)", category: "antioxidantes", price: null, image: "img/productos/organic-turmeric.jpg" },
  { id: "mer-12", brand: "mercola", name: "Vitamin B Complex con Benfotiamina", category: "vitaminas", price: null, image: "img/productos/vitamin-b-complex.jpg" },
  { id: "mer-13", brand: "mercola", name: "Complete Probiotics (Mujer)", category: "mujer", price: null, image: "img/productos/complete-probiotics-mujer.jpg" },
  { id: "mer-14", brand: "mercola", name: "Krill Oil (Mujer)", category: "mujer", price: null, image: "img/productos/krill-oil-mujer.jpg" },
  { id: "mer-15", brand: "mercola", name: "Organic Bone Broth Collagen", category: "colageno", price: null, image: "img/productos/organic-bone-broth-collagen.jpg" },
  { id: "mer-16", brand: "mercola", name: "Magnesium", category: "minerales", price: null, image: "img/productos/magnesium.jpg" },
  { id: "mer-17", brand: "mercola", name: "Liposomal Vitamin C (180)", category: "vitaminas", price: null, image: "img/productos/liposomal-vitamin-c-180.jpg" },
  { id: "mer-18", brand: "mercola", name: "Whole Food Complex (Mujer)", category: "mujer", price: null, image: "img/productos/whole-food-complex-mujer.jpg" },
  { id: "mer-19", brand: "mercola", name: "Creatine Monohidrate", category: "deportivo", price: null, image: "img/productos/creatine-monohidrate.jpg" },
  { id: "mer-20", brand: "mercola", name: "Complete Probiotics (Normal)", category: "probioticos", price: null, image: "img/productos/complete-probiotics-normal.jpg" },
  { id: "mer-21", brand: "mercola", name: "Calcium con Vitaminas D3 & K2", category: "minerales", price: null, image: "img/productos/calcium-d3-k2.jpg" },
  { id: "mer-22", brand: "mercola", name: "Methyl Folate", category: "vitaminas", price: null, image: "img/productos/methyl-folate.jpg" },
  { id: "mer-23", brand: "mercola", name: "Silica", category: "belleza", price: null, image: "img/productos/silica.jpg" },
  { id: "mer-24", brand: "mercola", name: "Zinc + Selenium", category: "minerales", price: null, image: "img/productos/zinc-selenium.jpg" },
  { id: "mer-25", brand: "mercola", name: "Resveratrol", category: "antioxidantes", price: null, image: "img/productos/resveratrol.jpg" },
  { id: "mer-26", brand: "mercola", name: "Liposomal Vitamin C (60)", category: "vitaminas", price: null, image: "img/productos/liposomal-vitamin-c-60.jpg" },
  { id: "mer-27", brand: "mercola", name: "Biothin MCT Oil", category: "energia", price: null, image: "img/productos/biothin-mct-oil.jpg" },
  { id: "mer-28", brand: "mercola", name: "Bone Broth Collagen from Beef", category: "colageno", price: null, image: "img/productos/bone-broth-collagen-beef.jpg" },
